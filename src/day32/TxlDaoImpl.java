...
//    写
    public  void toFile(TreeMap<String, List<Txl>> treeMap){
        try {
            ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("aa/txl.txt"));
            // 写入对象
    ...
    public  TreeMap<String, List<Txl>> fromFile(){
        try {
            ObjectInputStream oin = new ObjectInputStream(new FileInputStream("aa/txl.txt"));
            //
            TreeMap<String, List<Txl>> treeMap = (TreeMap<String, List<Txl>>) oin.readObject();
            //
            oin.close();
            return treeMap;
        } catch (Exception e) {
            return new TreeMap<String, List<Txl>>();
        }
    }
...
//        du
        TreeMap<String, List<Txl>> treeMap = fromFile();
//        把新加入的联系人添加到集合中
